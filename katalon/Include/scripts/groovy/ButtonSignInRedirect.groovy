...
class ButtonSignInRedirect {
	@Given("that the user has the app open")
	public void that_the_user_has_the_app_open() {
	...
	public void the_user_taps_the_sign_in_button() {
		Mobile.tap(findTestObject('Object Repository/android.widget.Button - SIGN IN'), 0)
	}

	@Then("the app opens the login page")
	public void the_app_opens_the_login_page() {
		Mobile.verifyElementExist(findTestObject('Object Repository/android.widget.Button - LOGIN'), 0)
	}
}