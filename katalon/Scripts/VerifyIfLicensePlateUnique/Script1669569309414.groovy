...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Matricula'), 'BB-92-CA', 0)
...
assert textMsg.equals("Já existe um user com esta matrícula")
